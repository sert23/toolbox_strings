...
def make_genome_1(scientific_name,release):
    ...
    directory="http://ftp.ensemblgenomes.org/pub/release-"+str(release)+"/metazoa/fasta/"+species_string+"/dna/"
    directoryf="ftp://ftp.ensemblgenomes.org/release-"+str(release)+"/metazoa/fasta/"+species_string+"/dna/"
...
def make_genome_link(scientific_name,release):
    ...
    directory="/pub/release-" + str(release) + "/metazoa/fasta/" + species_string + "/dna/"
    gpattern = "(.*\.dna\.toplevel\.fa\.gz)"
...
def make_cdna_link(scientific_name,release):
    ...
    species_string = species_name.replace(" ", "_")
    start_directory = "ftp.ensemblgenomes.org"
    directory = "/pub/release-" + str(release) + "/metazoa/fasta/" + species_string + "/cdna/"
...
def make_cds_link(scientific_name,release):
    ...
    species_string = species_name.replace(" ", "_")
    start_directory = "ftp.ensemblgenomes.org"
    directory = "/pub/release-" + str(release) + "/metazoa/fasta/" + species_string + "/cds/"
...
def make_ncrna_link(scientific_name,release):
    ...
    species_string = species_name.replace(" ", "_")
    start_directory = "ftp.ensemblgenomes.org"
    directory = "/pub/release-" + str(release) + "/metazoa/fasta/" + species_string + "/ncrna/"
...
def make_gff_link(scientific_name,release):
    ...
    species_string = species_name.replace(" ", "_")
    start_directory = "ftp.ensemblgenomes.org"
    directory = "/pub/release-" + str(release) + "/metazoa/gff3/" + species_string+ "/"
